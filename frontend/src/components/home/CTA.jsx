      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative overflow-hidden rounded-[40px] border border-[#47f375]/20 bg-linear-to-br from-neutral-950 via-black to-neutral-950 p-8 md:p-16">
          ...
          <div className="relative z-10 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#47f375]/20 bg-[#47f375]/5 px-4 py-2 text-sm text-[#47f375]">
              <ShieldCheck size={16} />
              Trusted Security Platform
            </div>

            <h2 className="mt-8 text-4xl font-bold text-white md:text-6xl leading-tight">
            ...
            <div className="mt-14 grid grid-cols-2 gap-6 md:grid-cols-4">
              {[
                ...
                >
                  <h3 className="text-2xl font-bold text-[#47f375]">
                    {value}
                  </h3>
