    ...
    <Container>
      <section className="relative w-full min-h-[85vh] md:min-h-screen flex flex-col-reverse md:flex-row items-center justify-between gap-10 overflow-hidden">
        ...
        <div className="relative z-10 flex-1 text-center md:text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#47f375]/20 bg-[#47f375]/5 backdrop-blur-xl mb-6">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight md:leading-20">
            Secure Every
            <span className="block text-[#47f375]">
              Password.
            </span>
            Access Anywhere.
          </h1>
          ...
          <p className="max-w-3xl mx-auto md:mx-0 mt-5 text-base md:text-xl lg:text-2xl text-neutral-400 leading-7 md:leading-9">
            ...
            keeping hackers and data breaches away from your digital life.
          </p>
